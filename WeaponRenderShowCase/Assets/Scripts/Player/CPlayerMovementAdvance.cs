...
public class CPlayerMovementAdvance : MonoBehaviour
{
   ...
   [SerializeField] private float baseFov;
    ...
    private void Update()
    {
        ...
        if (state != MovementState.sliding && state != MovementState.sprinting)
        {
    ...
    private void StateHandler()
    {
        ...
        if (sliding)
        {
            ...
            normalCam.fieldOfView = Mathf.Lerp(normalCam.fieldOfView, baseFov * sprintFOVModifier, Time.deltaTime);
